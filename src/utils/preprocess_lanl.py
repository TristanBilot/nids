...
if __name__ == "__main__":
    split(
        auth_file=LANL_AUTH_FILE,
        redteam_file=LANL_RED_FILE,
        dst_path=LANL_PREPROCESSED_AUTH_PATH,
    )
    
    split_flows(
        flows_path=LANL_FLOWS_FILE,
        redteam_file=LANL_RED_FILE,
        dst_path=LANL_PREPROCESSED_FLOWS_PATH,
        auth_path=LANL_PREPROCESSED_AUTH_PATH,
    )
